...
insert into book (name,enabled,img,price,isbn,storage,author,area,press,time) values("算法导论" ,1,"img/book/1.jpg",102.40,
	"9787111407010",10,"Thomas H.Cormen","美国","机械工业出版社","2013年1月");
insert into book (name,enabled,img,price,isbn,storage,author,area,press,time) values("计算机网络" ,1,"img/book/2.jpg",90.18,
	"9787111599715",15,"James F.Kurose,Keith W.Ross","美国","机械工业出版社","2014年10月");
insert into book (name,enabled,img,price,isbn,storage,author,area,press,time) values("计算机科学导论" ,1,"img/book/3.jpg",95.22,
	"9787111511632",32,"Behrouz A. Forouzan","美国","机械工业出版社","2016年8月");
insert into book (name,enabled,img,price,isbn,storage,author,area,press,time) values("数据库系统概念" ,1,"img/book/4.jpg",92.36,
	"9787111400851",51,"西尔伯沙茨,Henry F.Korth","美国","机械工业出版社","2013年1月");
insert into book (name,enabled,img,price,isbn,storage,author,area,press,time) values("Java编程思想" ,1,"img/book/5.jpg",100.50,
	"9787111213826",26,"埃克尔","美国","机械工业出版社","2013年5月");
insert into book (name,enabled,img,price,isbn,storage,author,area,press,time) values("代码大全" ,1,"img/book/6.jpg",128.00,
	"9787121022982",27,"迈克康奈尔","美国","电子工业出版社","2011年9月"); 
insert into book (name,enabled,img,price,isbn,storage,author,area,press,time) values("Java程序员修炼之道" ,1,"img/book/7.jpg",89.00,
	"9787115321954",97,"埃文斯","荷兰","人民邮电出版社","2013年8月"); 
insert into book (name,enabled,img,price,isbn,storage,author,area,press,time) values("计算机程序的构造和解释" ,1,"img/book/8.jpg",45.00,
	"9787111135104",139,"裘宗燕","中国","机械工业出版社","2004年2月"); 
insert into book (name,enabled,img,price,isbn,storage,author,area,press,time) values("C程序设计语言" ,1,"img/book/9.jpg",30.00,
	" 9787111128069",10,"BRIAN W KERN","美国","机械工业出版社","2005年4月"); 
insert into book (name,enabled,img,price,isbn,storage,author,area,press,time) values("算法导论" ,1,"img/book/10.jpg",128.00,
	" 9787111407010",54,"Thomas H.Cormen","美国","机械工业出版社","2005年4月"); 
insert into book (name,enabled,img,price,isbn,storage,author,area,press,time) values("重构：改善既有代码的设计" ,1,"img/book/11.jpg",168.00,
